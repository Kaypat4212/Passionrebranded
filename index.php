...
<head>
  ...
  <title>Kay xchange</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="Assests/favicon.png" rel="icon">
  <link href="Assests/favicon.png" rel="apple-touch-icon">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Useful links</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Learn</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="/Blogpost/introductiontoblockchain.html">Introduction to blockchain</a></li>
                  <li><a href="/Blogpost/Thebasicsofcryptocurrency.html">The basics of cryptocurrency</a></li>
                  <li>
                    <a href="/Blogpost/Typesofcryptocurrency.html">Types of cryptocurrencies</p>
                    <a href="/Learn.html"><Button class="btn btn-success">More</Button></a>
                  </li>
          ...
          <div class="d-flex justify-content-center">
            <a href=""><img width="150px" src="/Assests/appstore.png" alt=""></a>
            <!-- <li><a class="getstarted" href="https://user.kayxchange.net">Get Started</a></li> -->
          </div>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Buy, Sell and Exchange your Crypto to NGN <br> On <h3>Kay xchange</h3></h1>
          ...
          <div data-aos="fade-up" data-aos-delay="600">
            <div class="text-center text-lg-start">
              <a href="https://user.kayxchange.net" class="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img class="d-block w-100" src="/Assests/images/carousel/our rate dey buga.jpeg" alt="First slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="/Assests/images/carousel/You dont need to go far.jpeg" alt="Second slide">
                </div>
                <div class="carousel-item">
                  <img class="d-block w-100" src="/Assests/images/carousel/need naira for exchange.jpeg" alt="Third slide">
                </div>
              </div>
...
Bitcoin, often referred to as the king of cryptocurrencies, revolutionized the digital currency landscape.</p>
              ...
              <div class="tab-pane fade show" id="tab3">
                ...
                <p>Tether is a cryptocurrency that aims to bridge the gap between traditional fiat currencies and digital assets. Unlike most cryptocurrencies, Tether is a stablecoin designed to maintain a stable value by pegging it to a specific fiat currency, such as the US dollar.</p>
                <p>This stability makes USDT a preferred choice for traders and investors seeking to mitigate the volatility often associated with other cryptocurrencies. <br> USDT provides a reliable means of transferring value across different cryptocurrency exchanges and platforms.</p>
    ...
    <div class="row gy-4">
      ...
      <!-- <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
        <div class="service-box red">
          <img width="35px" src="https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/xrp.svg" alt="">
          <h3>Ripple</h3>
          <p>Trade Ripple to Naira and dive into the world of cross-border payments and remittances.</p>
          <a href="https://wa.me/09016740523" class="read-more"><span>Trade Now</span> <i class="bi bi-arrow-right"></i></a>
        </div>
      </div> -->
...
<div class="container" data-aos="fade-up" data-aos-delay="500">
  <div class="service-box green">
    <img width="125px" src="/Assests/favicon.png" alt="">
    <h3>Got other cryptocurrencies?</h3>
    <p>Kay xchange is here to Help you convert that to Naira</p>
    <div class="container">
      <div>
        <img width="350px" src="/Assests/mockup image.png" alt="">
      </div>
    </div>
...
<input type="submit" value="Subscribe">
      ...
      <div class="container">
        <div class="row gy-4">
          ...
          <div class="col-lg-2 col-6 footer-links">
            ...
            <ul>
              <li><i class="bi bi-chevron-right"></i> <a style="color: green;" href="/blog.html">Blog</a></li>
              <li><i class="bi bi-chevron-right"></i> <a style="color: green;" href="/Faqs.html">Faqs</a></li>
              <li><i class="bi bi-chevron-right"></i> <a style="color: green;" href="/Bitcoin.html">Bitcoin</a></li>
              <li><i class="bi bi-chevron-right"></i> <a style="color: green;" href="/Alts.html">Alts</a></li>
              <!-- <li><i class="bi bi-chevron-right"></i> <a style="color: green;" href="/Fiats.html">Fiats</a></li> -->
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              United States <br><br> -->
              <strong style="color: green;">Phone:</strong><span class="text-success">+2349016740523</span> <br>
              <strong style="color: green;">Email:</strong> <span style="color: green;">info@kayxchange.net</span><br>
              <strong style="color: green;">
                <a href="https://www.twitter.com/kay__xchange" class="twitter"><i class="bi bi-twitter"></i></a>
                <a href="https://api.whatsapp.com/send?phone=+2349016740523&text=Hello%2C%20I%20would%20like%20to%20start%20a%20trade" class="whatsapp"><i class="bi bi-whatsapp"></i></a>
                <a href="https://www.instagram.com/kay__xchange" class="instagram"><i class="bi bi-instagram"></i></a>
                <a href="https://t.snapchat.com/nIuJb4u1" class="snapchat"><i style="color: green;" class="bi bi-snapchat"></i></a>
              </strong>
            </p>
    ...
    <div class="container">
      <div style="color: green;" class="copyright">
        &copy; Copyright <strong><span>Kayxchange</span></strong>. <br> All Rights Reserved 2020-2023
      </div>
    </div>
  </footer><!-- End Footer -->
